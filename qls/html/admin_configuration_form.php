...
<fieldset>
	...
	<form action="#" method="get">
		<table border="0">
			...
			<tr>
				<td>
					<?php echo ADMIN_LOGIN_REDIRECT_URL_LABEL; ?>

				</td>
				<td>
					<input type="text" id="admin_login_redirect" name="admin_login_redirect" maxlength="255" value="<?php echo $qls->config['admin_login_redirect']; ?>" />
				</td>
			</tr>
			<tr>
				<td>
