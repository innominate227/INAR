...
var $permissions = array(
	...
	function edit_configuration() {
		...
		$admin_login_redirect = (isset($_GET['admin_login_redirect']) && strlen($_GET['admin_login_redirect']) < 256 && strlen($_GET['admin_login_redirect']) > 0) ? $this->qls->Security->make_safe($_GET['admin_login_redirect'], false) : false;
		...
		$auth_registration = ($_GET['auth_registration'] == 1 || $_GET['auth_registration'] == 0) ? $this->qls->Security->make_safe($_GET['auth_registration']) : false;
			...
			$this->configuration_error = ADMIN_ADMIN_LOGIN_REDIRECT_ERROR;
			return false;
			}
